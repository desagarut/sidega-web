	...
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<textarea id="link" name="link" class="form-control input-sm" placeholder="Contoh : https://www.youtube.com/@desagarut7718

Isi kolom ini dengan nama channel : @desagarut7718" style="height: 200px; resize: none;"><?php if ($main) : ?><?= $main['link']; ?><?php endif; ?></textarea>
				</div>
			</div>
			<div class="form-group row">
