...
<div class="form-group row">
	...
	<div class="col-sm-2 input-group input-group-sm date">
...
<div class="form-group row">
	...
	<div class="col">
		<input name="attr[keterangan]" class="col-sm-12 form-control input-sm" type="text" value="<?= $dokumen['attr']['keterangan'] ?>"></input>
	</div>
</div>