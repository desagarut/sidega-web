								...
								<form id="validasi" action="<?= $form_action ?>" method="POST" enctype="multipart/form-data" class="form-horizontal nomor-urut">
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input id="nomor_urut" name="nomor_urut" class="form-control form-control-sm input-sm number required" type="text" placeholder="Nomor Urut" value="<?= $surat_keluar['nomor_urut'] ?>"></input>
											</div>
										</div>
											...
											<div class="col-sm-9">
												<div class="input-group input-group-sm col-sm-12">
													...
													<span class="input-group-btn">
														<button type="button" class="btn btn-info btn-sm btn-box" id="file_browser"><i class="fa fa-search"></i> Browse</button>
													</span>
												</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input id="nomor_surat" name="nomor_surat" maxlength="35" class="form-control form-control-sm required nomor_sk" type="text" placeholder="Nomor Surat" value="<?= $surat_keluar['nomor_surat'] ?>"></input>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-3 control-label" for="tanggal_surat">Tanggal Surat</label>
											<div class="col-sm-3">
												<div class="input-group input-group-sm date" id="tgl_2" data-target-input="tanggal_surat">
													<input type="text" class="form-control datetimepicker-input" data-target="#tgl_2" name="tanggal_surat" type="text" value="<?= tgl_indo_out($surat_keluar['tanggal_surat']) ?>"/>
													<div class="input-group-append" data-target="#tgl_2" data-toggle="datetimepicker">
														<div class="input-group-text"><i class="fa fa-calendar"></i></div>
													</div>
												</div>&nbsp;<code>dd/mm/yyyy</code>
												<!--
