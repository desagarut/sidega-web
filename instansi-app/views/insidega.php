	...
	<div class="card card-outline card-primary">
		<div class="card-body">
			<div class="card-header text-center">
				<a href="<?= site_url('first'); ?>"><img src="<?= logo_web($header['logo']); ?>" alt="<?= $header['nama_website'] ?>" class="img-responsive" style="max-width: 80px; max-height: 80px" /></a>
			</div>
			<h1 align="center" style="font-size:18px"><strong>LOGIN <br /><?= strtoupper($this->setting->sebutan_singkat_website) ?> <?= strtoupper($header['nama_website']) ?></strong></h1>
