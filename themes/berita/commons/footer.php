                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-8">
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <h1 style="color: white; font-family:'Segoe UI', Tahoma"><a href="<?= site_url('') ?>"><img src="<?= gambar_institusi($desa['logo']) ?>" style="width:50px" alt="<?= $this->setting->website_title ?>">&nbsp;<?= $this->setting->website_title ?></a></h1>
                                </div>
