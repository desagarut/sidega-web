                        ...
                        <div class="col-12">
                            <div class="recent-active dot-style d-flex dot-style">
                                ...
                                <div class="single-recent">
                                    <div class="what-img">
                                        <img src="<?= base_url("$this->theme_folder/$this->theme/assets/img/gallery/tranding1.png") ?>" alt="">
                                    </div>
                                    <div class="what-cap">
                                        <h4><a href="#">
                                ...
                                <div class="single-recent">
                                    <div class="what-img">
                                        <img src="<?= base_url("$this->theme_folder/$this->theme/assets/img/gallery/tranding2.png") ?>" alt="">
                                    </div>
                                    <div class="what-cap">
                                        <h4><a href="latest_news.html">What to Expect From the 2020 Oscar Nomin
                                                ations</a></h4>
