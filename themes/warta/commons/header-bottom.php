        ...
        <div class="row align-items-center">
            <div class="col-xl-8 col-lg-8 col-md-12 header-flex">
                ...
                <div class="sticky-logo">
                    <h4 style="color: white; font-family:'Segoe UI', Tahoma"><a href="<?= site_url('first') ?>"><img src="<?= logo_web($desa['logo']) ?>" style="width:20px" alt="<?= $this->setting->website_title ?>">&nbsp;<?= $this->setting->website_title ?></a></h4>
                </div>
                <!-- Main-menu -->
